...
• AxionAOSP - A16
```
crave run --clean --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_sweet2/main/axion_a16.sh | bash"
```
• CherishOS A16
```
...
• Clover A16
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_sweet2/main/clover_a16.sh | bash"
```
• SkyLineUI A15
```
...
• PixelOS A16
```
crave run --no-patch -- "curl -v https://raw.githubusercontent.com/DarkKiller28/build_scripts_sweet2/main/pixelos_a16 | bash"
```
